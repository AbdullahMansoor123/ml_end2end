...
class ModelTrainer:
    ...
    def initialize_model_trainer(self,train_array, test_array):
        try:
            logging.info("Initizing model train and test split")
            ...
            logging.info(f"{best_model_name} is the Best Model based on train , test dataset")

            #save the best model in pickel format
            save_object(
